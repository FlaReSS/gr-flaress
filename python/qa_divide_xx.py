...
class qa_divide_xx (gr_unittest.TestCase):
    ...
    def test_001_int64_2 (self):
        """test_001_int64_2: divide int64 version with 2 inputs"""

        src_data1 = [int(x) for x in range(1, 16)]
        src_data2 = [int(x) for x in range(1, 16)]
