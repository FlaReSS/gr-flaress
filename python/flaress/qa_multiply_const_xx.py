...
class qa_multiply_const_xx (gr_unittest.TestCase):
    ...
    def test_001_int64_2 (self):
        """test_001_int64_2: multiply const int64 version with 2 inputs"""
        ...
        op = flaress.multiply_const_int64(const, 1)
...
if __name__ == '__main__':
    suite = gr_unittest.TestLoader().loadTestsFromTestCase(qa_multiply_const_xx)
