...
class qa_selector_ff (gr_unittest.TestCase):
    ...
    def test_000_t (self):
        ...
        # Blocks
        flaress_selector = flaress.selector_ff(0, 2, 1)
    ...
    def test_001_t (self):
        ...
        # Blocks
        flaress_selector = flaress.selector_ff(0, 3, 1)
    ...
    def test_002_t (self):
        ...
        # Blocks
        flaress_selector = flaress.selector_ff(0, 1, 2)
    ...
    def test_003_t (self):
        ...
        # Blocks
        flaress_selector = flaress.selector_ff(0, 1, 3)
