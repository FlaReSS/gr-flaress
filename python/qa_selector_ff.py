...
class qa_selector_ff (gr_unittest.TestCase):
    ...
    #
    #     # Blocks
    #     flaress_selector = flaress.selector_ff(1, 0, 2, 1)
    #
    ...
    #
    #     # Blocks
    #     flaress_selector = flaress.selector_ff(1, 0, 3, 1)
    #
    #     def _probe_func_probe():
    #         time.sleep(0.5)
    #         while True:
    ...
    #     dst_in0 = blocks.vector_sink_f()
    #     dst_in1 = blocks.vector_sink_f()
    #     dst_in2 = blocks.vector_sink_f()
    #     dst_out = blocks.vector_sink_f()
    #     head0 = blocks.head(gr.sizeof_float, N)
    #     head1 = blocks.head(gr.sizeof_float, N)
    #     head2 = blocks.head(gr.sizeof_float, N)
    #     sig_source0 = analog.sig_source_f(samp_rate,analog.GR_SAW_WAVE, 0.125 , 10, 0)
    #     sig_source1 = analog.sig_source_f(samp_rate,analog.GR_SAW_WAVE, 0.125 , 10, 11)
    #     sig_source2 = analog.sig_source_f(samp_rate,analog.GR_SAW_WAVE, 0.125 , -10, -1)
    #
    #     sig_source0.set_max_noutput_items (samp_rate)
    #     sig_source1.set_max_noutput_items (samp_rate)
    #     # sig_source0.set_max_output_buffer (samp_rate)
    ...
    #
    #     # Blocks
    #     flaress_selector = flaress.selector_ff(1, 0, 1, 2)
    #
    #     def _probe_func_probe():
    #         time.sleep(0.5)
    #         while True:
    ...
    #     dst_in = blocks.vector_sink_f()
    #     dst_out0 = blocks.vector_sink_f()
    #     dst_out1 = blocks.vector_sink_f()
    #     head = blocks.head(gr.sizeof_float, N)
    #     sig_source = analog.sig_source_f(samp_rate,analog.GR_SAW_WAVE, float(samp_rate / N) , 10, 0)
    #
    ...
    #
    #     # Blocks
    #     flaress_selector = flaress.selector_ff(1, 0, 1, 3)
    #
    #     def _probe_func_probe():
    #         time.sleep(0.5)
    #         while True:
    ...
    def test_004(self):
        """test 4: Test vectors (the gnuradio vector I/O type)"""
        ...
        # Blocks
        flaress_selector = flaress.selector_ff(vlen, 0, 1, 1)
        throttle = blocks.throttle(gr.sizeof_float*vlen, samp_rate, True)
        head = blocks.head(gr.sizeof_float*vlen, N)

        src_data = [float(x) for x in range(N)]
        data_in = tuple(src_data)
        ...
        tb.connect(throttle, head)
        tb.connect(head, (flaress_selector, 0))
        tb.connect(flaress_selector, dst)
...
if __name__ == '__main__':
    suite = gr_unittest.TestLoader().loadTestsFromTestCase(qa_selector_ff)
